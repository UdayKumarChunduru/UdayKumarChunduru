...
- 🧰 DevOps Engineer with 2.5 years of experience in CI/CD, automation, and infrastructure
- 🖥️ Hands-on with Bash Scripting, Python, Git, Vagrant, JSON, YAML, Maven, Jenkins, Terraform, Ansible, Docker, Linux, Networking, AWS, Containerization, Kubernetes, GitOps, Lift & Shift Cloud Migration, and Networking fundamentals
